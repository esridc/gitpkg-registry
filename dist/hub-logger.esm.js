...
var HubLogger = /*#__PURE__*/function () {
  function HubLogger(options) {
    var _options$sizeLimit, _options$labels;

    if (options === void 0) {
      options = {};
    }

    this.sizeLimit = (_options$sizeLimit = options.sizeLimit) != null ? _options$sizeLimit : 200 * 1000; // 200 KB
  ...
  _proto.log = function log(level, status, data) {
    var formatted = formatLog(level, status, Object.assign({}, this.globalLabels, data));
