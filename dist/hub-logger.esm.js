...
var HubLogger = /*#__PURE__*/function () {
  ...
  /**
   * Print a silly-level log.
   * @param status log status string
   * @param data log data
   */
  ;

  _proto.silly = function silly(status, data) {
    this.log('silly', status, data);
  }
  /**
   * Print a http-level log.
   * @param status log status string
   * @param data log data
   */
  ;

  _proto.http = function http(status, data) {
    this.log('http', status, data);
  }
  /**
   * Print a verbose-level log.
   * @param status log status string
   * @param data log data
   */
  ;

  _proto.verbose = function verbose(status, data) {
    this.log('verbose', status, data);
  }
  /**
